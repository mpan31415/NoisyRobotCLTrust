...
public:
  ...
  { 
    ...
    // tcp_pos_timer_ = this->create_wall_timer(50ms, std::bind(&GazeboController::tcp_pos_publisher, this));    // publishes at 20 Hz
...
{   
  ...
  std::shared_ptr<GazeboController> michael = std::make_shared<GazeboController>();
