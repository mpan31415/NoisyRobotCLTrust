...
bxp <- ggboxplot(
  data_df, x = "auto_grouped", y = "mdmt_ave",
...
ggqqplot(data_df, "mdmt_ave", ggtheme = theme_bw()) + facet_grid(auto_grouped ~ noisy_robot, labeller = "label_both")

######################### check variance homogeneity ######################### 
data_df %>%
  group_by(auto_grouped) %>%
  levene_test(mdmt_ave ~ noisy_robot*order)
...
res.aov <- anova_test(data = data_df, dv = mdmt_ave, wid = pid, within = auto_grouped, between = c(noisy_robot, order))
