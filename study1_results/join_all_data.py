...
DEMO_DATA_DIR = getcwd() + "\\study1_results\\demographic_logs\\"
MAIN_FORM_DIR = getcwd() + "\\study1_results\\questionnaire_logs\\"
PRIMARY_TASK_DIR = getcwd() + "\\study1_results\\traj_csv_logs\\"
TAPPING_TASK_DIR = getcwd() + "\\study1_results\\tapping_logs\\"
PUPIL_DATA_DIR = getcwd() + "\\study1_results\\tobii_logs\\"
ALL_DATA_DIR = getcwd() + "\\study1_results\\"


##########################################################################################
def get_demo_data():
    df = read_csv(DEMO_DATA_DIR + "cleaned.csv")
